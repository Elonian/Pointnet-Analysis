...
class PointNetFeat(nn.Module):
    ...
    def __init__(
        ...
        # point-wise MLP blocks from the PointNet encoder.
    ...
    def forward(self, pointcloud):
        ...
        if self.input_transform:
            trans = self.stn3(x)
            x = torch.bmm(pointcloud, trans).transpose(2, 1)
        ...
        return global_feature, point_features, trans, feat_trans
...
class PointNetCls(nn.Module):
    ...
    def forward(self, pointcloud):
        ...
        Output:
            ...
            - ...
        """
        global_feature, _, trans, feat_trans = self.pointnet_feat(pointcloud)
...
class PointNetPartSeg(nn.Module):
    ...
    def forward(self, pointcloud):
        ...
        Output:
            ...
            - ...
        """
        global_feature, point_features, trans, feat_trans = self.pointnet_feat(pointcloud)
